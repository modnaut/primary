...
public class EntityAttributeMethods
{
	...
	public static String getEntityAttribute(ENTITY_TYPES entityType, int entityId, ATTRIBUTES attribute)
	{
		HashMap<String, Object> parms = new HashMap<String, Object>();
		parms.put(ENTITY_TYPE_NAME, entityType.toString());
	...
	public static boolean getEntityAttributeBoolean(ENTITY_TYPES entityType, String entityName, ATTRIBUTES attribute)
	{
		String value = getEntityAttribute(entityType, entityName, attribute);
		return (value != null && value.equals(ICommonConstants.LETTER_Y));
	}

	public static Integer getEntityAttributeInteger(ENTITY_TYPES entityType, String entityName, ATTRIBUTES attribute)
	{
		Integer value = null;
	...
	public static Float getEntityAttributeFloat(ENTITY_TYPES entityType, String entityName, ATTRIBUTES attribute)
	{
		Float value = null;
		String stringValue = getEntityAttribute(entityType, entityName, attribute);
		if (stringValue != null)
	...
	public static boolean getEntityAttributeBoolean(ENTITY_TYPES entityType, int entityId, ATTRIBUTES attribute)
	{
		String value = getEntityAttribute(entityType, entityId, attribute);
		return (value != null && value.equals(ICommonConstants.LETTER_Y));
	}

	public static Integer getEntityAttributeInteger(ENTITY_TYPES entityType, int entityId, ATTRIBUTES attribute)
	{
		Integer value = null;
	...
	public static Float getEntityAttributeFloat(ENTITY_TYPES entityType, int entityId, ATTRIBUTES attribute)
	{
		Float value = null;
		String stringValue = getEntityAttribute(entityType, entityId, attribute);
		if (stringValue != null)
